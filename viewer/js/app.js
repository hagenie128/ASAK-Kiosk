...
async function bootstrap() {
  ...
  try {
    ...
    $("#view-dashboard").innerHTML = `<div class="panel"><p>데이터를 불러오지 못했습니다.</p><p class="meta-line">프론트는 1차 크롤링 산출물을 기본 포함하지 않습니다. 필요하면 <code>data-pipeline/phase1/output</code>에서 JSON을 별도로 복사하세요.</p><p class="meta-line"><code>python run_viewer.py</code> 실행 후 <code>data</code> 폴더 연결 상태를 확인하세요.</p></div>`;
  }
}
